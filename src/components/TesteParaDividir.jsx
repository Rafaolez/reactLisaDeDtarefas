...
function Segunda() {
  ...
  return (
    <>
      <DiaDeSemana texto=" Tarefas de Segunda" type="text" npme="tarefa" placeholder="Digite sua tarefa"  value= {tarefa.texto} onChange= { (e) => setTarefas( {id: Math.random(), texto: e.target.value, status: false} ) } onChange2={addTarefas} btnEscrita="Adicionar" />
